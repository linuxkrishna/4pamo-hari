/*
 * linux/arch/arm/mach-omap4/localtimer.c
 *
 * Copyright (C) 2005-2008 Texas Instruments, Inc.
 * Santosh Shilimkar <santosh.shilimkar@ti.com>
 *
 * This file is based on arm realview platfom file
 *
...
void __cpuinit local_timer_setup(unsigned int cpu)
{
	...
	twd_base_addr = IO_ADDRESS(OMAP44XX_LOCAL_TWD_BASE);
	twd_size = OMAP44XX_LOCAL_TWD_SIZE;
