 ...
 *
 *  @see    Notify_Attrs, Notify_exit ()
 *  ============================================================================
 */
extern Notify_Status Notify_init (IN Notify_Attrs * attrs) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_exit (void) ;
 ...
 *
 *  @see    Notify_Config, Notify_driverExit ()
 *  ============================================================================
 */
extern Notify_Status Notify_driverInit (IN  char *         driverName,
                   IN  Notify_Config * config,
                   OUT Notify_Handle * handle) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_driverExit (IN Notify_Handle handle) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_registerEvent (IN     Notify_Handle handle,
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_unregisterEvent (IN     Notify_Handle handle,
                        IN     Processor_Id  procId,
                        IN     u32        eventno,
                        IN     FnNotifyCbck  fnNotifyCbck,
                        IN OPT void *        cbckArg) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_sendEvent (IN Notify_Handle handle,
                  IN Processor_Id  procId,
                  IN u32        eventno,
                  IN u32        payload,
                  IN bool          waitClear) ;
 ...
 *  ============================================================================
 */
extern void * Notify_disable (void) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_restore (IN void * flags) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_disableEvent (IN Notify_Handle handle,
                     IN Processor_Id  procId,
                     IN u32        eventno) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_enableEvent (IN Notify_Handle handle,
                    IN Processor_Id  procId,
                    IN u32        eventNo) ;
 ...
 *  ============================================================================
 */
extern Notify_Status Notify_debug (IN Notify_Handle handle) ;
