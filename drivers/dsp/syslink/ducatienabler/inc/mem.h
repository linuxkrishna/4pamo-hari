 ...
 *      the size requested.
 */
	extern void *MEM_Alloc(u32 cBytes, enum MEM_POOLATTRS type);
 ...
 *      location of memory.
 */
	extern void *MEM_AllocPhysMem(u32 cBytes,
				      u32 ulAlign,
 ...
 */
	extern void *MEM_Calloc(u32 cBytes, enum MEM_POOLATTRS type);
 ...
 */
	extern void MEM_Free(void *pMemBuf);
 ...
 */
	extern void MEM_ExtPhysPoolInit(u32 poolPhysBase,
						u32 poolSize);
