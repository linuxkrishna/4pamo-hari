...
#define RETURN_16BITS_FROM_8LOWER_AND_8UPPER(lower8Bits,upper8Bits)\
    (((((unsigned long)lower8Bits)  & LOWER_8BIT_MASK                           )) | \
     (((((unsigned long)upper8Bits) & LOWER_8BIT_MASK) << UPPER_8BIT_OF16_SHIFT ))  )
...
#define RETURN_32BITS_FROM_4_8BIT_VALUES(lower8Bits, lowerMiddle8Bits, lowerUpper8Bits, upper8Bits)\
    (((((unsigned long)lower8Bits)        & LOWER_8BIT_MASK                            )) | \
     (((((unsigned long)lowerMiddle8Bits) & LOWER_8BIT_MASK) << LOWER_MIDDLE_8BIT_SHIFT)) | \
     (((((unsigned long)lowerUpper8Bits)  & LOWER_8BIT_MASK) << UPPER_MIDDLE_8BIT_SHIFT)) | \
     (((((unsigned long)upper8Bits)       & LOWER_8BIT_MASK) << UPPER_8BIT_SHIFT       ))  )
...
#define READ_UPPER_16BITS_OF_32(value32bits)\
    (((unsigned short)((unsigned long)(value32bits) >> UPPER_16BIT_SHIFT)) & LOWER_16BIT_MASK)
...
#define READ_LOWER_MIDDLE_8BITS_OF_32(value32bits)\
    (((unsigned char)((unsigned long)(value32bits) >> LOWER_MIDDLE_8BIT_SHIFT)) & LOWER_8BIT_MASK)
...
#define READ_UPPER_8BITS_OF_32(value32bits)\
    (((unsigned char)((unsigned long)(value32bits) >> UPPER_8BIT_SHIFT)) & LOWER_8BIT_MASK)
...
#define READ_UPPER_8BITS_OF_16(value16bits)\
    (((unsigned char)((unsigned long)(value16bits) >> UPPER_8BIT_SHIFT)) & LOWER_8BIT_MASK)
...
/* ----------------------------------------------------------------------------
* TYPE: volatile unsigned char, REG_WORD8       
*
...
/* ----------------------------------------------------------------------------
* TYPE: volatile unsigned short, REG_WORD16       
*
...
/* ----------------------------------------------------------------------------
* TYPE: volatile unsigned long, REG_WORD32       
*
...
* -----------------------------------------------------------------------------
*/
#define RD_MEM_8_VOLATILE(addr)	((unsigned char)(*((volatile unsigned char *)(addr))))
#define WR_MEM_8_VOLATILE(addr, data)	(*((volatile unsigned char *)(addr)) = (unsigned char)(data))
...
* -----------------------------------------------------------------------------
*/
#define RD_MEM_16_VOLATILE(addr)	((unsigned short)(*((volatile unsigned short *)(addr))))
#define WR_MEM_16_VOLATILE(addr, data)	(*((volatile unsigned short *)(addr)) = (unsigned short)(data))
...
* -----------------------------------------------------------------------------
*/
#define RD_MEM_32(addr)	((unsigned long)(*((unsigned long *)(addr))))
#define WR_MEM_32(addr, data)	(*((unsigned long *)(addr)) = (unsigned long)(data))
...
* -----------------------------------------------------------------------------
*/
#define RD_MEM_32_VOLATILE(addr)	((unsigned long)(*((volatile unsigned long *)(addr))))
#define WR_MEM_32_VOLATILE(addr, data)	(*((volatile unsigned long *)(addr)) = (unsigned long)(data))
