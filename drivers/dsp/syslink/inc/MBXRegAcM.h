    ...
    //
    //  Descs   MLB register access macros
    //
    //  Rev     0.1.0
    //
...
#define MLBMAILBOX_REVISIONReadRegister32(baseAddress)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+MLB_MAILBOX_REVISION_OFFSET))
...
#define MLBMAILBOX_REVISIONRevGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_REVISION_Rev_MASK) >> MLB_MAILBOX_REVISION_Rev_OFFSET))
...
#define MLBMAILBOX_SYSCONFIGReadRegister32(baseAddress)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+MLB_MAILBOX_SYSCONFIG_OFFSET))
...
{\
    ...
    WR_MEM_32_VOLATILE(((unsigned long)(baseAddress))+offset, newValue);\
}
...
#define MLBMAILBOX_SYSCONFIGClockActivityGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_ClockActivity_MASK) >> MLB_MAILBOX_SYSCONFIG_ClockActivity_OFFSET))
...
#define MLBMAILBOX_SYSCONFIGSIdleModeGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK) >> MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET))
...
#define MLBMAILBOX_SYSCONFIGSIdleModeIsb0032(var)\
    ((MLBMAILBOX_SYSCONFIGSIdleModeb00==(MLBMAILBOX_SYSCONFIGSIdleModeE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET)))
...
#define MLBMAILBOX_SYSCONFIGSIdleModeIsb0132(var)\
    ((MLBMAILBOX_SYSCONFIGSIdleModeb01==(MLBMAILBOX_SYSCONFIGSIdleModeE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET)))
...
#define MLBMAILBOX_SYSCONFIGSIdleModeIsb1032(var)\
    ((MLBMAILBOX_SYSCONFIGSIdleModeb10==(MLBMAILBOX_SYSCONFIGSIdleModeE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET)))
...
#define MLBMAILBOX_SYSCONFIGSIdleModeIsb1132(var)\
    ((MLBMAILBOX_SYSCONFIGSIdleModeb11==(MLBMAILBOX_SYSCONFIGSIdleModeE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET)))
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+offset);\
    register unsigned long newValue = ((unsigned long)(value));\
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGSIdleModeb00 <<\
                               MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK);\
    data |= newValue;\
    WR_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset, data);\
}
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGSIdleModeb01 <<\
                               MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK);\
    data |= newValue;\
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGSIdleModeb10 <<\
                               MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK);\
    data |= newValue;\
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGSIdleModeb11 <<\
                               MLB_MAILBOX_SYSCONFIG_SIdleMode_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_SIdleMode_MASK);\
    data |= newValue;\
...
#define MLBMAILBOX_SYSCONFIGSoftResetGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SoftReset_MASK) >> MLB_MAILBOX_SYSCONFIG_SoftReset_OFFSET))
...
#define MLBMAILBOX_SYSCONFIGSoftResetIsb032(var)\
    ((MLBMAILBOX_SYSCONFIGSoftResetb0==(MLBMAILBOX_SYSCONFIGSoftResetE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SoftReset_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_SoftReset_OFFSET)))
...
#define MLBMAILBOX_SYSCONFIGSoftResetIsb132(var)\
    ((MLBMAILBOX_SYSCONFIGSoftResetb1==(MLBMAILBOX_SYSCONFIGSoftResetE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_SoftReset_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_SoftReset_OFFSET)))
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGSoftResetb0 <<\
                               MLB_MAILBOX_SYSCONFIG_SoftReset_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_SoftReset_MASK);\
    data |= newValue;\
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGSoftResetb1 <<\
                               MLB_MAILBOX_SYSCONFIG_SoftReset_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_SoftReset_MASK);\
    data |= newValue;\
...
#define MLBMAILBOX_SYSCONFIGAutoIdleGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_AutoIdle_MASK) >> MLB_MAILBOX_SYSCONFIG_AutoIdle_OFFSET))
...
#define MLBMAILBOX_SYSCONFIGAutoIdleIsb032(var)\
    ((MLBMAILBOX_SYSCONFIGAutoIdleb0==(MLBMAILBOX_SYSCONFIGAutoIdleE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_AutoIdle_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_AutoIdle_OFFSET)))
...
#define MLBMAILBOX_SYSCONFIGAutoIdleIsb132(var)\
    ((MLBMAILBOX_SYSCONFIGAutoIdleb1==(MLBMAILBOX_SYSCONFIGAutoIdleE)((((unsigned long)(var)) & MLB_MAILBOX_SYSCONFIG_AutoIdle_MASK) >>\
      MLB_MAILBOX_SYSCONFIG_AutoIdle_OFFSET)))
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGAutoIdleb0 <<\
                               MLB_MAILBOX_SYSCONFIG_AutoIdle_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_AutoIdle_MASK);\
    data |= newValue;\
...
{\
    const unsigned long offset = MLB_MAILBOX_SYSCONFIG_OFFSET;\
    const unsigned long newValue = (unsigned long)MLBMAILBOX_SYSCONFIGAutoIdleb1 <<\
                               MLB_MAILBOX_SYSCONFIG_AutoIdle_OFFSET;\
    register unsigned long data = RD_MEM_32_VOLATILE((unsigned long)(baseAddress)+offset);\
    data &= ~(MLB_MAILBOX_SYSCONFIG_AutoIdle_MASK);\
    data |= newValue;\
...
#define MLBMAILBOX_SYSSTATUSReadRegister32(baseAddress)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+MLB_MAILBOX_SYSSTATUS_OFFSET))
...
#define MLBMAILBOX_SYSSTATUSResetDoneGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_SYSSTATUS_ResetDone_MASK) >> MLB_MAILBOX_SYSSTATUS_ResetDone_OFFSET))
...
#define MLBMAILBOX_SYSSTATUSResetDoneIsrstongoing32(var)\
    ((MLBMAILBOX_SYSSTATUSResetDonerstongoing==(MLBMAILBOX_SYSSTATUSResetDoneE)((((unsigned long)(var)) & MLB_MAILBOX_SYSSTATUS_ResetDone_MASK) >>\
      MLB_MAILBOX_SYSSTATUS_ResetDone_OFFSET)))
...
#define MLBMAILBOX_SYSSTATUSResetDoneIsrstcomp32(var)\
    ((MLBMAILBOX_SYSSTATUSResetDonerstcomp==(MLBMAILBOX_SYSSTATUSResetDoneE)((((unsigned long)(var)) & MLB_MAILBOX_SYSSTATUS_ResetDone_MASK) >>\
      MLB_MAILBOX_SYSSTATUS_ResetDone_OFFSET)))
...
#define MLBMAILBOX_MESSAGE___0_15ReadRegister32(baseAddress, bank)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_MESSAGE___REGSET_0_15_OFFSET +\
      MLB_MAILBOX_MESSAGE___0_15_OFFSET+((bank)*MLB_MAILBOX_MESSAGE___REGSET_0_15_STEP))))
...
#define MLBMAILBOX_MESSAGE___0_15MessageValueMBmGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_MESSAGE___0_15_MessageValueMBm_MASK) >> MLB_MAILBOX_MESSAGE___0_15_MessageValueMBm_OFFSET))


/********************************************************************/


#define MLBMAILBOX_MESSAGE___0_15MessageValueMBmWrite32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_MESSAGE___REGSET_0_15_OFFSET +\
                             MLB_MAILBOX_MESSAGE___0_15_OFFSET +\
                             ((bank) * MLB_MAILBOX_MESSAGE___REGSET_0_15_STEP);\
...
#define MLBMAILBOX_MESSAGE___0_15MessageValueMBmSet32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_MESSAGE___0_15_MessageValueMBm_MASK)) |\
...
#define MLBMAILBOX_FIFOSTATUS___0_15ReadRegister32(baseAddress, bank)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_FIFOSTATUS___REGSET_0_15_OFFSET +\
      MLB_MAILBOX_FIFOSTATUS___0_15_OFFSET+((bank)*MLB_MAILBOX_FIFOSTATUS___REGSET_0_15_STEP))))
...
#define MLBMAILBOX_FIFOSTATUS___0_15FifoFullMBmGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_FIFOSTATUS___0_15_FifoFullMBm_MASK) >> MLB_MAILBOX_FIFOSTATUS___0_15_FifoFullMBm_OFFSET))
...
#define MLBMAILBOX_MSGSTATUS___0_15ReadRegister32(baseAddress, bank)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_MSGSTATUS___REGSET_0_15_OFFSET +\
      MLB_MAILBOX_MSGSTATUS___0_15_OFFSET+((bank)*MLB_MAILBOX_MSGSTATUS___REGSET_0_15_STEP))))
...
#define MLBMAILBOX_MSGSTATUS___0_15NbOfMsgMBmGet32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_MSGSTATUS___0_15_NbOfMsgMBm_MASK) >> MLB_MAILBOX_MSGSTATUS___0_15_NbOfMsgMBm_OFFSET))
...
#define MLBMAILBOX_IRQSTATUS___0_3ReadRegister32(baseAddress, bank)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
      MLB_MAILBOX_IRQSTATUS___0_3_OFFSET+((bank)*MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP))))
...
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB15Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB15_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB15_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB15Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB15Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB15_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB15_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB15_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB15Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB15_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB15_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB15Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB15Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB15_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB15_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB15_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB14Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB14_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB14_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB14Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB14Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB14_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB14_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB14_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB14Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB14_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB14_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB14Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB14Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB14_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB14_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB14_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB13Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB13_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB13_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB13Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB13Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB13_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB13_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB13_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB13Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB13_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB13_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB13Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB13Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB13_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB13_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB13_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB12Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB12_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB12_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB12Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB12Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB12_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB12_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB12_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB12Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB12_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB12_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB12Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB12Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB12_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB12_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB12_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB11Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB11_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB11_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB11Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB11Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB11_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB11_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB11_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB11Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB11_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB11_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB11Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB11Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB11_MASK)) |\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB10Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB10_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB10_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB10Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB10Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB10_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB10_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB10_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB10Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB10_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB10_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB10Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB10Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB10_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB10_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB10_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB9Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB9_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB9_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB9Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB9Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB9_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB9_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB9_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB9Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB9_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB9_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB9Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB9Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB9_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB9_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB9_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB8Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB8_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB8_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB8Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB8Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB8_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB8_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB8_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB8Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB8_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB8_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB8Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB8Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB8_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB8_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB8_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB7Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB7_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB7_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB7Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB7Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB7_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB7_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB7_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB7Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB7_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB7_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB7Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB7Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB7_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB7_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB7_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB6Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB6_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB6_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB6Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB6Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB6_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB6_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB6_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB6Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB6_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB6_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB6Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB6Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB6_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB6_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB6_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB5Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB5_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB5_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB5Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB5Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB5_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB5_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB5_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB5Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB5_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB5_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB5Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB5Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB5_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB5_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB5_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB4Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB4_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB4_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB4Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB4Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB4_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB4_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB4_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB4Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB4_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB4_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB4Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB4Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB4_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB4_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB4_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB3Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB3_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB3_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB3Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB3Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB3_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB3_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB3_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB3Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB3_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB3_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB3Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB3Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB3_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB3_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB3_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB2Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB2_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB2_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB2Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB2Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB2_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB2_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB2_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB2Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB2_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB2_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB2Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB2Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB2_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB2_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB2_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB1Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB1_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB1_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB1Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB1Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB1_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB1_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB1_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB1Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB1_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB1_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB1Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB1Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB1_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB1_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB1_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB0Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB0_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB0_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB0Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NotFullStatusUuMB0Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB0_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB0_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NotFullStatusUuMB0_MASK)))
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB0Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB0_MASK) >> MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB0_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB0Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQSTATUS___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQSTATUS___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQSTATUS___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQSTATUS___0_3NewMsgStatusUuMB0Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB0_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB0_OFFSET) &\
      MLB_MAILBOX_IRQSTATUS___0_3_NewMsgStatusUuMB0_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3ReadRegister32(baseAddress, bank)\
    (RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
      MLB_MAILBOX_IRQENABLE___0_3_OFFSET+((bank)*MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP))))
...
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB15Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB15_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB15_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB15Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB15Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB15_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB15_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB15_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB15Read32(baseAddress, bank)\
    ((((RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
      MLB_MAILBOX_IRQENABLE___0_3_OFFSET+((bank)*MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP)))) &\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB15Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB15_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB15_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB15Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB15Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB15_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB15_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB15_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB14Read32(baseAddress, bank)\
    ((((RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+(MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
      MLB_MAILBOX_IRQENABLE___0_3_OFFSET+((bank)*MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP)))) &\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB14Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB14_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB14_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB14Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB14Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB14_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB14_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB14_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB14Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB14_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB14_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB14Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB14Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB14_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB14_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB14_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB13Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB13_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB13_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB13Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB13Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB13_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB13_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB13_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB13Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB13_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB13_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB13Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB13Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB13_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB13_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB13_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB12Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB12_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB12_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB12Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB12Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB12_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB12_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB12_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB12Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB12_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB12_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB12Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB12Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB12_MASK)) |\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB11Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB11_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB11_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB11Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB11Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB11_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB11_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB11_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB11Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB11_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB11_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB11Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB11Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB11_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB11_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB11_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB10Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB10_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB10_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB10Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB10Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB10_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB10_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB10_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB10Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB10_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB10_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB10Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB10Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB10_MASK)) |\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB9Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB9_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB9_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB9Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB9Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB9_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB9_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB9_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB9Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB9_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB9_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB9Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB9Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB9_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB9_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB9_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB8Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB8_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB8_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB8Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB8Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB8_MASK)) |\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB8Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB8_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB8_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB8Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB8Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB8_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB8_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB8_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB7Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB7_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB7_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB7Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB7Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB7_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB7_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB7_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB7Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB7_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB7_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB7Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB7Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB7_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB7_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB7_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB6Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB6_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB6_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB6Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB6Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB6_MASK)) |\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB6Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB6_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB6_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB6Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB6Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB6_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB6_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB6_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB5Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB5_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB5_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB5Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB5Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB5_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB5_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB5_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB5Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB5_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB5_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB5Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB5Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB5_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB5_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB5_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB4Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB4_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB4_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB4Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB4Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB4_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB4_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB4_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB4Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB4_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB4_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB4Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB4Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB4_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB4_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB4_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB3Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB3_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB3_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB3Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB3Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB3_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB3_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB3_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB3Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB3_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB3_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB3Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB3Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB3_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB3_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB3_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB2Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB2_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB2_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB2Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB2Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB2_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB2_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB2_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB2Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB2_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB2_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB2Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB2Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB2_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB2_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB2_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB1Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB1_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB1_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB1Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB1Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB1_MASK)) |\
      ((((unsigned long)(value)) << MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB1_OFFSET) &\
      MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB1_MASK)))
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB1Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB1_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB1_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB1Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB1Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB1_MASK)) |\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB0Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB0_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB0_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB0Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NotFullEnableUuMB0Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NotFullEnableUuMB0_MASK)) |\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB0Get32(var)\
    ((unsigned long)((((unsigned long)(var)) & MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB0_MASK) >> MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB0_OFFSET))


/********************************************************************/


#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB0Write32(baseAddress, bank, value)\
{\
    const unsigned long offset = MLB_MAILBOX_IRQENABLE___REGSET_0_3_OFFSET +\
                             MLB_MAILBOX_IRQENABLE___0_3_OFFSET +\
                             ((bank) * MLB_MAILBOX_IRQENABLE___REGSET_0_3_STEP);\
...
#define MLBMAILBOX_IRQENABLE___0_3NewMsgEnableUuMB0Set32(var, value)\
    (((((unsigned long)(var)) & ~(MLB_MAILBOX_IRQENABLE___0_3_NewMsgEnableUuMB0_MASK)) |\
