...
(RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+\
...
do {\
	...
	WR_MEM_32_VOLATILE(((unsigned long)(baseAddress))+ \
	offset, newValue);\
} while (0)
...
do {\
	...
	RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+offset);\
	register unsigned long newValue = ((unsigned long)(value));\
...
#define MLBMAILBOX_IRQSTATUS_CLR___0_3ReadRegister32(baseAddress, bank)\
(RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+\
...
do {\
	...
	MEM_32_VOLATILE(((unsigned long)(baseAddress))+offset);\
	register unsigned long newValue = ((unsigned long)(value));\
...
#if defined(OMAP44XX) || defined(VPOM4430_1_06)
#define MLBMAILBOX_IRQENABLE_SET___0_3ReadRegister32(baseAddress, bank)\
(RD_MEM_32_VOLATILE(((unsigned long)(baseAddress))+\
...
#if defined(OMAP44XX) || defined(VPOM4430_1_06)
#define MLBMAILBOX_IRQENABLE_SET___0_3WriteRegister32(baseAddress, bank, value)\
do {\
	const unsigned long offset = \
	MLB_MAILBOX_IRQENABLE_SET___REGSET_0_3_OFFSET +\
...
#define MLBMAILBOX_IRQENABLE_CLR___0_3WriteRegister32(baseAddress, bank, value)\
do {\
	const unsigned long offset = \
