 ...
 *  Ensures:
 */
	extern signed long int CLK_Enable(IN enum SERVICES_ClkId clk_id);
 ...
 *  Ensures:
 */
	extern signed long int CLK_Disable(IN enum SERVICES_ClkId clk_id);
 ...
 *  Ensures:
 */
	extern signed long int CLK_GetRate(IN enum SERVICES_ClkId clk_id,
				     u32 *speedMhz);
/*
 *  ======== CLK_Set_32KHz ========
 *  Purpose:
 ...
 *  Ensures:
 */
	extern signed long int CLK_Set_32KHz(IN enum SERVICES_ClkId clk_id);
