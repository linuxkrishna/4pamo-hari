...
#define DSP_SBASE               (signed long int)0x00008000l
#define DSP_SLAST               (signed long int)0x00008500l

/* Base and range of component success codes */
#define RINGIO_SBASE            (signed long int)0x00008100l
#define RINGIO_SLAST            (signed long int)0x000081FFl

/* Base and range of generic error codes */
#define DSP_EBASE               (signed long int)0x80008000l
#define DSP_ELAST               (signed long int)0x800081FFl

/* Base and range of component error codes */
#define DSP_COMP_EBASE          (signed long int)0x80040200l
#define DSP_COMP_ELAST          (signed long int)0x80047fffl
