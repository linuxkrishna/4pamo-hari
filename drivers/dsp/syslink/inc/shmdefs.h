...
*  ============================================================================
*/
#define IPC_ALIGN(x, y) \
(unsigned long int)((unsigned long int)((x + y - 1) / y) * y)
...
*  ============================================================================
*/
#define IPC_16BIT_PADDING  \
((CACHE_L2_LINESIZE - sizeof(unsigned short int)) / 2)
...
*  ============================================================================
*/
#define IPC_32BIT_PADDING  \
((CACHE_L2_LINESIZE - sizeof(unsigned long int)) / 2)
...
*  ============================================================================
*/
#define IPC_64BIT_PADDING  \
((CACHE_L2_LINESIZE - (sizeof(unsigned long int) * 2)) / 2)
