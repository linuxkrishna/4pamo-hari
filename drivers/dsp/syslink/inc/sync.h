 ...
 *      DSP_Evoid *:    Invalid handle.
 *  Requires:
 *      SYNC initialized.
 *  Ensures:
 *      Any subsequent usage of hEvent would be invalid.
 */
	 signed long int SYNC_CloseEvent(IN struct SYNC_OBJECT *hEvent);
 ...
 *  Ensures:
 */
	 signed long int SYNC_DeleteCS(IN struct SYNC_CSOBJECT *hCSObj);
 ...
 *  Ensures:
 */
	 signed long int SYNC_EnterCS(IN struct SYNC_CSOBJECT *hCSObj);
 ...
 *  Ensures:
 */
	 signed long int SYNC_InitializeCS(OUT struct SYNC_CSOBJECT **phCSObj);
 ...
 *  Ensures:
 */
	 signed long int SYNC_InitializeDPCCS(OUT struct SYNC_CSOBJECT
					       **phCSObj);
 ...
 *  Ensures:
 */
	 signed long int SYNC_LeaveCS(IN struct SYNC_CSOBJECT *hCSObj);
 ...
 */
	 signed long int SYNC_OpenEvent(OUT struct SYNC_OBJECT **phEvent,
 ...
 *      DSP_Evoid *:    Invalid Window handle
 *  Requires:
 *      SYNC initialized
 *  Ensures
 */
 ...
 *  Ensures:
 */
	 signed long int SYNC_ResetEvent(IN struct SYNC_OBJECT *hEvent);
 ...
 *  Ensures:
 */
	 signed long int SYNC_SetEvent(IN struct SYNC_OBJECT *hEvent);
 ...
 *  Ensures:
 */
	 signed long int SYNC_WaitOnEvent(IN struct SYNC_OBJECT *hEvent,
					   IN u32 dwTimeOut);
 ...
 *  Ensures:
 */
	 signed long int SYNC_WaitOnMultipleEvents(IN struct SYNC_OBJECT
						    **hSyncEvents,
						    IN u32 uCount,
						    IN u32 dwTimeout,
						    OUT u32 *puIndex);
