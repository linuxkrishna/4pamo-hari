 ...
 */
signed long int SYNC_CloseEvent(struct SYNC_OBJECT *hEvent)
{
 ...
 */
signed long int SYNC_ResetEvent(struct SYNC_OBJECT *hEvent)
{
	signed long int status = DSP_SOK;
	struct SYNC_OBJECT *pEvent = (struct SYNC_OBJECT *)hEvent;
...
signed long int SYNC_SetEvent(struct SYNC_OBJECT *hEvent)
{
	signed long int status = DSP_SOK;
	struct SYNC_OBJECT *pEvent = (struct SYNC_OBJECT *)hEvent;
	unsigned long  flags;
 ...
 */
signed long int SYNC_WaitOnEvent(struct SYNC_OBJECT *hEvent, u32 dwTimeout)
{
	signed long int status = DSP_SOK;
	struct SYNC_OBJECT *pEvent = (struct SYNC_OBJECT *)hEvent;
	u32 temp;
 ...
 *      specified timeout.
 */
signed long int SYNC_WaitOnMultipleEvents(struct SYNC_OBJECT **hSyncEvents,
 ...
 *  ======== SYNC_DeleteCS ========
 */
signed long int SYNC_DeleteCS(struct SYNC_CSOBJECT *hCSObj)
{
	signed long int status = DSP_SOK;
 ...
 *  ======== SYNC_EnterCS ========
 */
signed long int SYNC_EnterCS(struct SYNC_CSOBJECT *hCSObj)
{
	signed long int status = DSP_SOK;
	struct SYNC_CSOBJECT *pCSObj = (struct SYNC_CSOBJECT *)hCSObj;
 ...
 *  ======== SYNC_LeaveCS ========
 */
signed long int SYNC_LeaveCS(struct SYNC_CSOBJECT *hCSObj)
{
	signed long int status = DSP_SOK;
	struct SYNC_CSOBJECT *pCSObj = (struct SYNC_CSOBJECT *)hCSObj;
